...
ax1.plot(data[0],(data[4]-nImp2_DDZero)-data[7],linewidth=2,marker='o',linestyle='--',label='2-site DMET: Neutral gap')#,color='k')
ax1.plot(data[0],(data[3]-nImp4_Zero)-data[7],linewidth=2,marker='s',label='4-site DMET: Quasiparticle gap')#,color='r')
ax1.plot(data[0],(data[5]-nImp4_DDZero)-data[7],linewidth=2,marker='o',linestyle='--',label='4-site DMET: Neutral gap')#,color='r')
