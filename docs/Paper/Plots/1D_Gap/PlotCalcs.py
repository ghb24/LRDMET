...
data=mlab.load('GAPS',usecols=[0,1,2,3,4,5],unpack=True)
...
#ax1.plot(data_BA[0],data_BA[1],linewidth=2,label='Bethe Ansatze',color='b')
#ax1.plot(data[0],data[1],linewidth=1,label='2-site DMET (Reopt GS)',color='g')
ax1.plot(data[0],data[1]-data[5],linewidth=2,marker='s',label='2-site DMET: Quasiparticle gap')#,color='g')
ax1.plot(data[0],(data[4]-nImp2_Opt_Zero)-data[5],linewidth=2,marker='o',label='2-site DMET: Neutral gap')#,color='k')
ax1.plot(data[0],(data[3]-nImp4_Zero)-data[5],linewidth=2,marker='s',label='4-site DMET: Quasiparticle gap')#,color='r')
