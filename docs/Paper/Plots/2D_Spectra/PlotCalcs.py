...
ax2.plot(data[0],data[1],linewidth=2,color='r')
...
ax3.plot(data[0],data[1],linewidth=2,color='r')
...
ax4.plot(data[0],data[1],linewidth=2,color='r')
...
ax5.plot(data[0],data[1],linewidth=2,color='r')
