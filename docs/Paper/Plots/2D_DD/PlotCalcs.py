...
ax2 = subplot(2,2,1)
data=mlab.load('U4/EC-TDA_DDResponse_4.00_All',usecols=[0,2],unpack=True)
ax2.plot(data[0],data[1],linewidth=2,color='b')
ax2.annotate('U = 4t',xy=(35,-15),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='16')
#xlim(-3.587,3.587)
ylabel(r'$\chi(\omega)$')
...
#xlim(-7,7)
ax3 = subplot(2,2,2)
data=mlab.load('U6/EC-TDA_DDResponse_6.00_All',usecols=[0,2],unpack=True)
ax3.plot(data[0],data[1],linewidth=2,color='b')
ax3.annotate('U = 6t',xy=(35,-15),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='16')
#xlim(-3.457,3.457)
#setp(ax2.get_xticklabels(),visible=False)
setp(ax3.get_yticklabels(),visible=False)
#xlim(-7,7)
ax4 = subplot(2,2,3)
data=mlab.load('U8/EC-TDA_DDResponse_8.00_All',usecols=[0,2],unpack=True)
ax4.plot(data[0],data[1],linewidth=2,color='b')
ax4.annotate('U = 8t',xy=(35,-15),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='16')
#xlim(-6,6)
xlabel(r'$\omega$ / t')
ylabel(r'$\chi(\omega)$')
#setp(ax2.get_xticklabels(),visible=False)
...
#xlim(-7,7)
ax5 = subplot(2,2,4)
data=mlab.load('U10/EC-TDA_DDResponse_10.00_All',usecols=[0,2],unpack=True)
ax5.plot(data[0],data[1],linewidth=2,color='b')
ax5.annotate('U = 10t',xy=(40,-15),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='16')
#setp(ax2.get_xticklabels(),visible=False)
