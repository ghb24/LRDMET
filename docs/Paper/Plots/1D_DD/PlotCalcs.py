...
#ax1.plot(data_NoReopt3[0],data_NoReopt3[1],linewidth=1,linestyle='dashed',label='3-site',color='g')
ax2.annotate('U = 4',xy=(-15,-9),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='15')
#ax1.legend(loc=2)
#setp(ax1.get_xticklabels(),visible=False)
...
#ax1.plot(data_NoReopt3[0],data_NoReopt3[1],linewidth=1,linestyle='dashed',label='3-site',color='g')
ax3.annotate('U = 6',xy=(-15,-9),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='15')
#ax1.legend(loc=2)
#setp(ax1.get_xticklabels(),visible=False)
...
#ax1.plot(data_NoReopt3[0],data_NoReopt3[1],linewidth=1,linestyle='dashed',label='3-site',color='g')
ax4.annotate('U = 8',xy=(-15,-9),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='15')
#ax1.legend(loc=2)
#setp(ax1.get_xticklabels(),visible=False)
