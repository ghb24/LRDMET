...
ax1.annotate('U = 2t',xy=(-18,-9),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='15')
ax1.legend(loc=2)
...
#ax1.plot(data_NoReopt3[0],data_NoReopt3[1],linewidth=1,linestyle='dashed',label='3-site',color='g')
ax2.annotate('U = 4t',xy=(-25,-9),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='15')
#ax1.legend(loc=2)
#setp(ax1.get_xticklabels(),visible=False)
...
#ax1.plot(data_NoReopt3[0],data_NoReopt3[1],linewidth=1,linestyle='dashed',label='3-site',color='g')
ax3.annotate('U = 6t',xy=(-25,-9),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='15')
#ax1.legend(loc=2)
#setp(ax1.get_xticklabels(),visible=False)
...
#ax1.plot(data_NoReopt3[0],data_NoReopt3[1],linewidth=1,linestyle='dashed',label='3-site',color='g')
ax4.annotate('U = 8t',xy=(-25,-9),xycoords='axes points',xytext=None, textcoords='offset points',horizontalalignment='right', verticalalignment='bottom',fontsize='15')
#ax1.legend(loc=2)
#setp(ax1.get_xticklabels(),visible=False)
...
subplots_adjust(hspace=0.15,wspace=0.04)
