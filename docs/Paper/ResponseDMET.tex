...
Here, we aim to circumvent these issues, by generalizing and extending the idea of quantum embedding of {\emph states}, as introduced in Ref.~\onlinecite{Chan2012}. 
...
%In this letter, we restrict ourselves to consider one- and two-electron Greens functions for simplicity, 
