...
!  MODULE PROCEDURE read_single, read_double!, read_quad
  MODULE PROCEDURE read_double  !read_single, read_double!, read_quad
END INTERFACE
...
case("GREY","GRAY")
  ...
  colour(:)=c
case("RGB")
  call read_single(colour(1))
  call read_single(colour(2))
  call read_single(colour(3))
case("RGB255")
  call read_single(colour(1),255.0_sp)
  call read_single(colour(2),255.0_sp)
  call read_single(colour(3),255.0_sp)
case("RGBX")
  call readu(x)
  read (x(1:2),"(z2)") r
  colour(1)=r/255d0
