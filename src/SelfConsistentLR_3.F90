module SelfConsistentLR3
    ...
    subroutine SC_Spectrum_Static()
        ...
        !TODO: MOVE SETFREQPOINTS TO NEW ROUTINE - INCLUDE EIGENVALUES
        ...
        do while(.not.tSkip_Lattice_Fit)
            ...
            call CalcLatticeSpectrum(1,nFitPoints,Lat_CorrFn,GFChemPot,tMatbrAxis=.true.,    &
            ...
            if(tCalcRealSpectrum.or.(iter.eq.1)) then
                ...
                !call writedynamicfunction(nFreq_Re,Lat_CorrFn_Re,'G_Lat_Re',tag=iter,    &
                !    tCheckCausal=.true.,tCheckOffDiagHerm=.true.,tWarn=.true.,tMatbrAxis=.false.)
